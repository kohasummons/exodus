<script setup>
    ...
    <div class="lab-page">
        <main
            class="relative h-[calc(100vh-32px)] border border-[#FAFAFA] bg-[#FFFFFF] rounded-xl flex flex-col justify-between">
...
<style scoped>
.lab-page {
    @apply bg-[#F5F5F5] overscroll-none p-2 min-h-screen;
}
